...
function Product(){
    return (
        ...
        <div className='col-md-3 col-lg-3 col-xl-3 align-items-center text-start'>
            <img style={{display:"block",marginLeft:"auto",marginRight:"auto",minWidth:"80%",maxWidth:"100%"}} src="images/test_for_browse/white_side_table.jpeg" alt="white_side_table" width={250}/>
